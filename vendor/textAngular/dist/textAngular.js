				...
				if(attrs.ngModel){
					...
					ngModel.$render = function(){
						if(_firstRun){
							...
							_firstRun = false;
							// if mvvm.js value is null or undefined initially and there was original content, set to the original content
